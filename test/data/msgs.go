...
var Msgs = []*pb.CloudEvent{
	{
		Id:          fmt.Sprintf("test-msg0-%d", time.Now().Unix()),
	...
	{
		Id:          fmt.Sprintf("test-msg1-%d", time.Now().Unix()),
	...
	{
		Id:          fmt.Sprintf("test-msg2-%d", time.Now().Unix()),
	...
	{
		Id:          fmt.Sprintf("test-msg3-%d", time.Now().Unix()),
	...
	{
		Id:          fmt.Sprintf("test-msg4-%d", time.Now().Unix()),
